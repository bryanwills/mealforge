    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-3">Join MealForge</h1>
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            Your comprehensive recipe management and meal planning companion
          </p>
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            Create your account to start managing recipes, meal plans, and grocery lists
          </p>
        </div>
        <SignUp
          appearance={{
